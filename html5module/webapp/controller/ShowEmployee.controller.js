...
//Dejamos filtro constante para nuesto SapId

			var defaultFilter = new Filter("SapId", FilterOperator.EQ, "ydiazs@sapimsa.com");
			aFilters.push(defaultFilter);
			if (sQuery && sQuery.length > 0) {

//Aplicamos el filtrado cuando exista una entrada valida para el SapId constante ydiazs@sapimsa.com
	...
	function onRiseEmployee(oEvent){
		if(!this.riseDialog){
            //this.riseDialog = sap.ui.xmlfragment("empleados360/ydiazs/fragment/RiseEmployee", this);
			this.riseDialog = sap.ui.xmlfragment("empleados360/ydiazs/HTML5Module/fragment/RiseEmployee", this);
	...
	return Controller.extend("empleados360.ydiazs.HTML5Module.controller.ShowEmployee", {
		onInit: onInit,
