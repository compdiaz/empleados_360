		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados 360",
									"targetURL": "#empleados360-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"empleados360-display": {
								"semanticObject": "empleados360",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=empleados360",
									"url": sap.ui.require.toUrl("empleados360")
								}
							}
						}
					}
